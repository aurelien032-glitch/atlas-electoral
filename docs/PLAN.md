...
- Correctifs locaux de contours (Q25) : faits le 26/09 (Q27 à Q29), avec tous les découpages ouverts trouvés et le contour détaillé des villes montrées en entier. À surveiller : les nouvelles publications des villes (Marseille, Nice, Lille, Béziers, La Rochelle…).
