...
| 1. Bureaux sans contour | **Fait le 26/09** (Q25) : au zoom des bureaux, la carte montre la commune là où les contours manquent (Troyes, Belfort…) ou ne désignent plus les bureaux du scrutin (Bordeaux et Paris Centre en 2024) ; la légende donne la part des inscrits concernés, la fiche le nombre de bureaux. Bordeaux dessinée bureau par bureau aux scrutins de 2024 par le découpage de Bordeaux Métropole (Q27) ; Paris Centre (découpage de 2024 de la Ville de Paris, ODbL) et Alès (méthode de l'Insee) le 26/09 (Q28), ainsi que les cinq communes aux contours de 2022 faux | Lyon, Nantes, Brest… (P2) |
...
- Correctifs locaux de contours (Q25) : Bordeaux (Q27), Paris Centre et Alès (Q28) faits le 26/09 ; restent Lyon, Nantes, Brest… (P2), et un contour détaillé pour les villes montrées en entier (Troyes, Belfort, Dieppe, Aurillac : leur contour simplifié n'a qu'une dizaine de points).
