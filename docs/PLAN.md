...
- Correctifs locaux de contours (Q25) : Bordeaux 2024 d'abord (Bordeaux Métropole, Licence Ouverte), puis Alès et Aurillac (contours « méthode de l'Insee », ODbL : choix de licence à faire), Paris, Lyon, Nantes, Brest…
...
| Q27 | « faire » : traiter ce qui restait (recoloriage sur téléphone, contours de Bordeaux) | **Recoloriage réalisé le 26/09** : sous la seconde sur téléphone émulé en vue nationale (voir la revue P0, § 12) ; zoom des bureaux et contours de Bordeaux ensuite | P1 |
