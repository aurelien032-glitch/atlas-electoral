...
| Q23 | Encarts sur petit écran (« on ne voit pas bien la fenêtre petite couronne et outre-mer », « l'icône doit rester pour revenir à la carte France métropolitaine ») | **Tranché et réalisé le 26/09** : dans le volet (téléphone, petite fenêtre, tablette tenue verticalement), les encarts s'ouvrent dans le panneau, en grande grille, et la carte garde la France entière ; leur bouton reste quand la carte est zoomée et ramène à la France entière | — |
