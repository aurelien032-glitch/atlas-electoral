...
| `src/panneau/` | Aperçu de chaque mode, détail d'un territoire (fil d'Ariane, résultats en tableau, nuances), « Au fil des scrutins » (courbes SVG et tableau), page Méthodologie (`?page=methodologie`) |
